...
<link rel="stylesheet"
	...
	type="text/css" media="screen">
<link rel="stylesheet"
	href='<c:out value="${pageContext.request.contextPath}"/>/resources/css/bootstrap-responsive.css'
	type="text/css" media="screen">
<link rel="stylesheet"
	href='<c:out value="${pageContext.request.contextPath}"/>/resources/css/camera.css'
	type="text/css" media="screen">
...
<script type="text/javascript"
	src='<c:out value="${pageContext.request.contextPath}"/>/resources/js/jquery.easing.1.3.js'></script>
<script type="text/javascript"
	src='<c:out value="${pageContext.request.contextPath}"/>/resources/js/superfish.js'></script>

<script type="text/javascript"
	src='<c:out value="${pageContext.request.contextPath}"/>/resources/js/jquery.ui.totop.js'></script>

<script type="text/javascript"
	src='<c:out value="${pageContext.request.contextPath}"/>/resources/js/cform.js'></script>
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<form id="addToCart"
													action="${pageContext.request.contextPath}/myCart/add/${product.productid}" method="post">
									...
									<tfoot>
										<tr>
											...
											<td align="center" colspan="2">
												<button type="submit" form="addToCart" class="btn btn-info">Add
													to Cart</button>
											</td>
							...
							<div class="slogan1">
								<div class="row">
									<div class="span4 block1">
										...
										<div class="txt1">
											Made with love<br>for <span>special</span> day
										</div>

										<div class="txt2">Order our Kolkata special Cakes online
											made for the people of Kolkata. You can get online cake
											delivery in Kolkata to any location in Kolkata city.</div>

									</div>
									<div class="span4 block2">

										<img
											src='<c:out value="${pageContext.request.contextPath}"/>/resources/images/special1.png'
											alt="" class="img">
									...
									<div class="span4 block3">
										...
										<div class="txt2">Vibrant and vivacious, this Royal
											Albert cake stand offers a beautiful two-tier, vintage
											design. This cake stand is rendered in fine bone china and
											...</div>
		...
		<div class="container">
			<div class="row">
				<div class="span12">
							...
							<div class="span2 block1">
								<div class="logo_wrapper2">
									<a href="index.html" class="logo"><img
										src='<c:out value="${pageContext.request.contextPath}"/>/resources/images/logo2.png'
										alt=""></a>
								</div>
							</div>
							<div class="span7 block2">
								<div class="phone1">
									Best cakes <span>123-456-789</span>
								</div>
					...
					<footer>Copyright &copy; 2017. All rights reserved. Cake
					Nation shop.</footer>
				</div>
			</div>
		</div>
